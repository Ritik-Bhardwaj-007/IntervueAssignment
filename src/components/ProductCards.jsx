      ...
      <div className=" mx-20 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="border p-4 rounded-lg shadow">
          <div className="flex items-center mb-4">
            <div className="border shadow-md rounded-sm mb-2"> <img className='h-48' src="./pic1.png"></img></div>
          </div>
        ...
        <div className="border p-4 rounded-lg shadow">
          <div className="flex items-center mb-4">
          <div className="border shadow-md rounded-sm mb-2"> <img className='h-48' src="./pic2.png"></img></div>
          </div>
        ...
        <div className="border p-4 rounded-lg shadow">
          <div className="flex items-center mb-4">
          <div className="border shadow-md rounded-sm mb-2"> <img className='h-48' src="./pic3.png"></img></div>
          </div>
